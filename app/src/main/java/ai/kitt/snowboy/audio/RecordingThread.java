...
//    private String activeModel = strEnvWorkSpace+ACTIVE_UMDL;
    private String activeModel = ACTIVE_UMDL;
    ...
    public RecordingThread(Handler handler, AudioDataReceivedListener listener) {
        ...
        detector.SetSensitivity("0.5"); //todo SET sensitivity for EACH keyword
    ...
    private void record() {
        ...
        while (shouldContinue) {
            ...
            if (result == -2) {
                ...
                switch (result) {
                    case 1:
                        Log.e("Snowboy: ", "Hotword " + Integer.toString(result) + " Novaya zapis detected!");
                        break;
//                    case 2:
//                        Log.e("Snowboy: ", "Hotword " + Integer.toString(result) + " Otmenit deistviye detected!");
//                        break;
                    case 2:
                        Log.e("Snowboy: ", "Hotword " + Integer.toString(result) + " Zavershit rabotu detected!");
                        break;
                }
                sendMessage(MsgEnum.MSG_ACTIVE, result);
//                Log.e("Snowboy: ", "Hotword " + Integer.toString(result) + " detected!");
                player.start();
            }
        }
